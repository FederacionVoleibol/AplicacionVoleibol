...
public class VentanaDePruena extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaDePruena frame = new VentanaDePruena();
	...
	public VentanaDePruena() {
		...
		btnClasificacion.setBounds(10, 28, 89, 21);
